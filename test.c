...
*   1 player gamemode will include AI powered bot
*   
*   Project done by ---
*
********************************************************************************************/
...
int checkIfWon(char *a[ROW_SIZE][ROW_SIZE]) {
    int matches;
    ...
    if (a[1][1] != " ") {
        ...
        if (a[0][0] == player && a[1][1] == player && a[2][2] == player) return 1;
        if (a[0][2] == player && a[1][1] == player && a[2][0] == player) return 1;
    }
